...
public class BookLogReader
{
    ...
    private void parseLog2Html()
    {
        ...
        new HtmlCreator().createHtml( unKnown, duplicateSet, inSentenceList,
                explainMap );
    }
    ...
    private Map<Integer, Map> getExplainMap()
    {
        ...
        String sql = "SELECT ID,TOPIC_WORD,MEAN_CN,WEIGHT FROM dictionary WHERE id IN ("
                + join + ")";
    ...
    {
        RunCmd.runCommand( "cmd /c \"C:\\Program Files (x86)\\Google\\Chrome\\Application\\chrome.exe\" "
    ...
    private List<String> getLatelyLogs()
    {
        ...
        {
            String day = BasicDateUtil.getDateBeforeDayDateString(
                    BasicDateUtil.getCurrentDateString(), i );
