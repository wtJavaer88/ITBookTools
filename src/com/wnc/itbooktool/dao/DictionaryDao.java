...
public class DictionaryDao
{
    ...
    public synchronized static WordExpand findSameAntonym( int topic_id )
    {
        ...
        try
        {
            ...
            for ( int i = 1; i <= selectAllSqlMap.size(); i++ )
            {
                ...
                wordExpand
                        .setSame_analysis( getMapStr( rowMap, "same_analysis" ) );
                return wordExpand;
            }
        } catch ( Exception e )
        {
            ...
            WordExchange wordExchange ) throws SQLException
    {
        ...
        util.addInsertField( new DbField( "WORD_ING", wordExchange
                .getWord_ing() ) );
        util.addInsertField( new DbField( "WORD_PAST", wordExchange
                .getWord_past() ) );
        util.addInsertField( new DbField( "WORD_EST", wordExchange
                .getWord_est() ) );
